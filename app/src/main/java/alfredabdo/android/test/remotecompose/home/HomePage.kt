...
import alfredabdo.android.test.remotecompose.examples.adaptive.AdaptiveRoute
    ...
    Column(modifier) {
        ...
        LazyColumn(
            ...
            item {
                Item(
                    "Animated Example",
                    onClick = { onRedirectTo(AnimatedRoute.RemoteCreator) },
                    Modifier.fillMaxWidth(),
                )
            }
            ...
            item {
                Item(
                    "Adaptive Example",
                    onClick = { onRedirectTo(AdaptiveRoute.RemoteCreator) },
                    Modifier.fillMaxWidth(),
                )
            }
